...
update_compile_order -fileset sources_1
import_files -norecurse {iCacheRegisters.v}
update_compile_order -fileset sources_1
...
apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config { Clk_master {/processing_system7_0/FCLK_CLK0 (75 MHz)} Clk_slave {/processing_system7_0/FCLK_CLK0 (75 MHz)} Clk_xbar {/processing_system7_0/FCLK_CLK0 (75 MHz)} Master {/core_0/iPort} Slave {/processing_system7_0/S_AXI_HP0} ddr_seg {Auto} intc_ip {/axi_mem_intercon_1} master_apm {0}}  [get_bd_intf_pins core_0/iPort]
create_bd_cell -type module -reference bootROM bootROM_0
apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config { Clk_master {/processing_system7_0/FCLK_CLK0 (75 MHz)} Clk_slave {Auto} Clk_xbar {/processing_system7_0/FCLK_CLK0 (75 MHz)} Master {/core_0/iPort} Slave {/bootROM_0/req} ddr_seg {Auto} intc_ip {/axi_mem_intercon_1} master_apm {0}}  [get_bd_intf_pins bootROM_0/req]
...
startgroup
apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config { Clk_master {/processing_system7_0/FCLK_CLK0 (75 MHz)} Clk_slave {Auto} Clk_xbar {/processing_system7_0/FCLK_CLK0 (75 MHz)} Master {/core_0/peripheral} Slave {/psClint_0/client} ddr_seg {Auto} intc_ip {/axi_mem_intercon} master_apm {0}}  [get_bd_intf_pins psClint_0/client]
